...
class HistoryBuffer:
    """Track a series of scalar values and provide access to smoothed values
    over a window or the global average of the series."""
    ...
    def median(self, window_size: int) -> float:
        """Return the median of the latest `window_size` values in the
        buffer."""
    ...
    def global_avg(self) -> float:
        ...
        Note that this includes those getting removed due to limited buffer
        storage.
        """
