...
class VisualBERT(nn.Module):
    ...
    def flatten_for_bert(self, sample_list, **kwargs):
        ...
        flattened = self.flatten(sample_list, to_be_flattened,
                                 to_be_flattened_dim)
        return flattened
    ...
    def add_custom_params(self, sample_list):
        ...
        # pretraining labels
        sample_list.masked_lm_labels = getattr(sample_list, 'lm_label_ids',
                                               None)
    ...
    def format_state_key(cls, key):
        return (key.replace('bert.bert', 'model.bert').replace(
            'bert.cls', 'model.cls').replace('bert.classifier',
                                             'model.classifier'))
    ...
    def forward(self, data):
        ...
        output_dict = self.model(
            ...
            None,  #sample_list.position_embeddings_visual,
            data['visual_embeddings_type'],
            None,  #sample_list.image_text_alignment,
