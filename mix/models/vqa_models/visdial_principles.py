...
class VISDIALPRINCIPLES(nn.Module):
  ...
  def forward(self, data):
    ...
    q_output, c_output, his_feat = self.encoder_model(ques_embed, ques_len,
                                                      cap_emb, cap_len,
                                                      his_embed, hist_len)
    ...
    fuse_feat = self.backbone(ques_encoded, cap_encoded, his_feat, q_output,
                              c_output, ques_len, cap_len, ques_embed, cap_emb,
                              img, batch_size)
