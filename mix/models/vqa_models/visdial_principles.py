...
class VISDIALPRINCIPLES(nn.Module):
    ...
    def __init__(self, vocabulary_len, word_embedding_size, encoder, backbone,
                 head):
        super().__init__()

        self.embedding_model = nn.Embedding(
    ...
    def forward(self, data):
        ...
        q_output, c_output, his_feat = self.encoder_model(
            ques_embed, ques_len, cap_emb, cap_len, his_embed, hist_len)
        ...
        fuse_feat = self.backbone(ques_encoded, cap_encoded, his_feat,
                                  q_output, c_output, ques_len, cap_len,
