...
class Config:
    ...
    def __init__(self,
        ...
        super().__setattr__('_cfg_eDict', MIXEasyDict(cfg_dict))
    ...
    def __repr__(self):
        return 'Config path:{} /n content:{}'.format(
            self.filename, self._cfg_eDict.__repr__())
