...
train_data = dict(
    ...
    data=dict(
        ...
        split='trainval',
        image_features_reader=train_image_features_reader_cfg,
        gt_image_features_reader=train_gt_image_features_reader_cfg,
...
test_data = dict(
    ...
    data=dict(
        ...
        annotations_jsonpath='',
        split='minval',
        image_features_reader=image_features_reader_cfg,
        gt_image_features_reader=gt_image_features_reader_cfg,
        tokenizer='/home/datasets/VQA/bert/bert-base-uncased',
        padding_index=0,
        max_seq_length=16,
        max_region_num=100),
