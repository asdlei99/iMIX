...
model = dict(
    ...
    encoder=dict(
        ...
        in_dim=2048,
        weights_file='/home/zrz/.cache/torch/mmf/data/models/detectron.vmb_weights/fc7_w.pkl',
        bias_file='/home/zrz/.cache/torch/mmf/data/models/detectron.vmb_weights/fc7_b.pkl'
    ),
    backbone=dict(
        ...
        modal_combine=dict(
            ...
            params=dict(dropout=0.5, hidden_dim=1024, attention_dim=1024)),
