...
import logging
from ..builder import DATASETS # added by wbq
import numpy as np
import torch
...
class DeVLBertVQADATASET(Dataset):
    def __init__(
        self,
        task: str,
        dataroot: str,
        ...
        tokenizer: str, #chagned from to BertTokenizer str(wbq)
        padding_index: int = 0,
        ...
        self._image_features_reader = ImageFeaturesH5Reader(image_features_reader.features_path)
        #self._tokenizer = tokenizer
        self._tokenizer = BertTokenizer.from_pretrained(tokenizer, do_lower_case=True)
