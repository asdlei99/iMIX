...
def _get_conv():
    if TORCH_VERSION == 'parrots':
        from parrots.nn.modules.conv import _ConvNd, _ConvTransposeimixin
    else:
        from torch.nn.modules.conv import _ConvNd, _ConvTransposeimixin
    return _ConvNd, _ConvTransposeimixin
...
_ConvNd, _ConvTransposeimixin = _get_conv()
