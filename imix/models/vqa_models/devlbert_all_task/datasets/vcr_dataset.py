...
class VCRDataset(Dataset):
    ...
    def __init__(self,
        ...
        self._names = []
        # with open('/home/wbq/Desktop/0323/DeVLBert-master/data/VCR/unisex_names_table.csv') as csv_file:
    ...
    def tokenize(self):
        ...
        for entry in self._entries:
            # metadata_fn = json.load(open(os.path.join('/home/datasets/VCR/vcr1images', entry["metadata_fn"]), 'r'))
    ...
    def __getitem__(self, index):
        ...
        co_attention_mask = torch.zeros(
            (len(entry['co_attention_mask']), self._max_region_num, self._max_caption_length))
