...
class FlickrGroundingDataset(Dataset):
    ...
    def _load_annotations(self, clean_datasets):
        ...
        with open(
                os.path.join('/checkpoint/vedanuj/datasets/flickr30k', '%s.txt' % self.split),
                'r',
        ) as f:
        ...
        for img in images:
            ...
            annotation = get_annotations(
                os.path.join('/checkpoint/vedanuj/datasets/flickr30k/Annotations', img + '.xml'))
            sentences = get_sentence_data(
                os.path.join('/checkpoint/vedanuj/datasets/flickr30k/Sentences', img + '.txt'))
