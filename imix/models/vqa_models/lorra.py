...
class LoRRA(PYTHIA):
    ...
    def forward_train(self, data):
        ...
        context_embedding_total, _ = self.process_context_feature_embedding(data, text_embedding_total,
                                                                            data['order_vectors'])

        joint_embedding = self.combine_model(image_embedding_total, text_embedding_total, context_embedding_total)
