...
#
#   def compute_loss(self, pred_anchor_list, bbox, anchors_full):
#     gt_param, gi, gj, best_n_list = build_target(bbox, pred_anchor_list, anchors_full)
...
#     ## loss
#     loss = yolo_loss(pred_anchor_list, gt_param, gi, gj, best_n_list)
#     losses = {'loss': loss}
#
#     return losses
#
...
#
#     losses = self.compute_loss(pred_anchor, bbox, anchors_full)
#     return losses
