from transformers.modeling_bert import (BertSelfAttention, BertAttention,
                                        BertEncoder, BertLayer, BertSelfOutput,
...
class CaptionBertSelfAttention(BertSelfAttention):
  """Modified from BertSelfAtntion to add support for output_hidden_states."""
...
class OSCARBackbone(BertPreTrainedModel):
  ...
  def forward(self, embedding_output, extended_attention_mask, head_mask,
